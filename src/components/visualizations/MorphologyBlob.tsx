        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <StatusRow label={t('visualizations.blob.vars.complexity')} value={morphology.complexity} detail={`${t('visualizations.blob.vars.arms')}: ${blobData.arms}`} visualColor={getDimensionVisuals('complexity', blobData).color} visualIcon={getDimensionVisuals('complexity', blobData).icon} isSelected={selectedDimension === 'complexity'} onClick={() => setSelectedDimension(selectedDimension === 'complexity' ? null : 'complexity')} />
              
              <StatusRow label={t('visualizations.blob.vars.stakeholder')} value={morphology.stakeholder} detail={`${t('visualizations.blob.vars.roughness')}: ${(blobData.roughness * 100).toFixed(0)}%`} visualColor={getDimensionVisuals('stakeholder', blobData).color} visualIcon={getDimensionVisuals('stakeholder', blobData).icon} isSelected={selectedDimension === 'stakeholder'} onClick={() => setSelectedDimension(selectedDimension === 'stakeholder' ? null : 'stakeholder')} />
              
              <StatusRow label={t('visualizations.blob.vars.knowledge')} value={morphology.knowledge} detail={`${t('visualizations.blob.vars.pattern')}: ${t(`visualizations.blob.patterns.${blobData.innerPattern}`)}`} visualColor={getDimensionVisuals('knowledge', blobData).color} visualIcon={getDimensionVisuals('knowledge', blobData).icon} visualPattern={blobData.innerPattern} isSelected={selectedDimension === 'knowledge'} onClick={() => setSelectedDimension(selectedDimension === 'knowledge' ? null : 'knowledge')} />
              
              <StatusRow label={t('visualizations.blob.vars.cultural')} value={morphology.cultural} detail={`${t('visualizations.blob.vars.colors')}: ${blobData.colorSpread}`} visualColor={getDimensionVisuals('cultural', blobData).color} visualIcon={getDimensionVisuals('cultural', blobData).icon} isSelected={selectedDimension === 'cultural'} onClick={() => setSelectedDimension(selectedDimension === 'cultural' ? null : 'cultural')} />
              
              <StatusRow label={t('visualizations.blob.vars.organizational')} value={morphology.organizational} detail={`${t('visualizations.blob.vars.symmetry')}: ${(blobData.symmetry * 100).toFixed(0)}%`} visualColor={getDimensionVisuals('organizational', blobData).color} visualIcon={getDimensionVisuals('organizational', blobData).icon} isSelected={selectedDimension === 'organizational'} onClick={() => setSelectedDimension(selectedDimension === 'organizational' ? null : 'organizational')} />
              
              <StatusRow label={t('visualizations.blob.vars.temporal')} value={morphology.temporal} detail={`${t('visualizations.blob.vars.pulse')}: ${blobData.pulseSpeed.toFixed(1)}s`} visualColor={getDimensionVisuals('temporal', blobData).color} visualIcon={getDimensionVisuals('temporal', blobData).icon} isSelected={selectedDimension === 'temporal'} onClick={() => setSelectedDimension(selectedDimension === 'temporal' ? null : 'temporal')} />
              
              <StatusRow label={t('visualizations.blob.vars.development')} value={morphology.development} detail={`${t('visualizations.blob.vars.coreGlow')}: ${(blobData.coreGlow * 100).toFixed(0)}%`} visualColor={getDimensionVisuals('development', blobData).color} visualIcon={getDimensionVisuals('development', blobData).icon} glowIntensity={blobData.coreGlow} isSelected={selectedDimension === 'development'} onClick={() => setSelectedDimension(selectedDimension === 'development' ? null : 'development')} />
            </div>
          </div>
        </div>
